@php
    $accessControlDropdown = [
        'permissions' => [
            ...
            'access'    => ['view_permissions', 'add_permission', 'edit_permission']
        ],
        'roles'       => [
            'route'     => route('roles'),
                ...
                <div class="ms-3 relative">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            ...
                            @else
                                <span class="inline-flex rounded-md">
                                    <x-profile-img :imgUrl="Auth::user()->profile_photo_path ? asset(Auth::user()->profile_photo_path) : asset('/storage/avatar/user.png')" size="8" />
                                    <button type="button" class="inline-flex items-center px-2 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 bg-white hover:text-gray-700 focus:outline-none focus:bg-gray-50 active:bg-gray-50 transition ease-in-out duration-150">
                                        {{ Auth::user()->name }}
